...
export const authenCode = pgTable('t_nhso_authencode', {
    ...
    claim_type: varchar('claim_type').notNull(),
    claim_code: varchar('claim_code').notNull(),
...
export type SelectAuthenCode = typeof authenCode.$inferSelect;
export type InsertAuthenCode = typeof authenCode.$inferInsert;